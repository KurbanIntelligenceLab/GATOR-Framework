...
class ElectronicProperties:
    ...
    def __init__(self, epsilon_homo: float, epsilon_lumo: float, material_name: str):
        """
    ...
    def _calculate_properties(self):
        ...
        self.ip_koop = np.floor(ip_raw * 1000) / 1000 if ip_raw * 1000 % 1 == 0.5 else round(ip_raw, 3)
        self.ea_koop = np.floor(ea_raw * 1000) / 1000 if ea_raw * 1000 % 1 == 0.5 else round(ea_raw, 3)
    ...
    def to_dict(self, system_name: Optional[str] = None) -> Dict[str, float]:
        """
    ...
    def __repr__(self) -> str:
        ...
        return (f"ElectronicProperties(epsilon_homo={self.epsilon_homo:.4f} eV, "
...
def calculate_metrics_from_homo_lumo(epsilon_homo: float, epsilon_lumo: float, 
                                     material_name: str) -> Dict[str, float]:
    """
